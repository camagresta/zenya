...
export const WhyCBD = () => {
  return (
    <div id="learnAboutCBD" className="whyCBDmain">
      ...
      <div className="cbdInfo">
        ...
        <p className="smallerP cbdP larger">
          ...
          plant, which is a cousin of the marijuana plant. Because it’s
        ...
        <p className="smallerP cbdP">
          ...
          sunt explicabo. Nemo enim ipsam voluptatem quia, sed quia consequuntur
